        ...
        <div className="lg:flex lg:items-center">
          <div className="w-full space-y-12 lg:w-1/2 ">
            <div>
              <h1 className="text-2xl font-semibold text-gray-800 capitalize lg:text-3xl dark:text-white">
                Knowing our <br /> awesome Products?
              </h1>
            ...
            <div className="md:flex md:items-start md:-mx-4">
              ...
              <div className="mt-4 md:mx-4 md:mt-0">
                ...
                <p className="mt-3 text-gray-500 dark:text-gray-300">
                  Emphasize the use of cutting-edge technology in your mobile
                  products, such as advanced processors, high-resolution
                  displays, and AI-powered cameras. Highlight how these
                  technologies enhance performance, user experience, and
                  future-proof the devices.
                </p>
              </div>
            </div>
            ...
            <div className="md:flex md:items-start md:-mx-4">
              ...
              <div className="mt-4 md:mx-4 md:mt-0">
                ...
                <p className="mt-3 text-gray-500 dark:text-gray-300">
                  Showcase the focus on user experience with designs that are
                  both stylish and ergonomic. Mention features like slim
                  profiles, durable materials, and intuitive interfaces that
                  make your products easy and enjoyable to use.
                </p>
              </div>
            </div>
            ...
            <div className="md:flex md:items-start md:-mx-4">
              ...
              <div className="mt-4 md:mx-4 md:mt-0">
                ...
                <p className="mt-3 text-gray-500 dark:text-gray-300">
                  Reinforce your dedication to quality by discussing rigorous
                  testing, high manufacturing standards, and the use of premium
                  materials. Mention your commitment to delivering reliable,
                  long-lasting products that users can trust.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="hidden lg:flex lg:items-center lg:w-1/2 lg:justify-center">
            <img
              ...
              src="https://i.ibb.co/0FBQ133/about.jpg"
              alt=""
            />
          </div>
        </div>
